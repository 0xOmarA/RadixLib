...
class StakeTokens(Serializable):
    ...
    def __init__(
        ...
        Args:
            from_account (AccountIdentifier): The account that is staking their tokens.
            to_validator (AccountIdentifier): The validator to stake the tokens at.
        ...
        self.to_validator: ValidatorIdentifier = to_validator
    ...
    def from_dict(
        ...
        return cls(
            ...
            to_validator = ValidatorIdentifier(dictionary['to_validator']['address']),
